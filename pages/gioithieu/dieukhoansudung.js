  ...
  return (
    <div className="col-inner">
      ...
      <p>Mitsubishi Kim Liên Hà Nội xin gửi lời chào trân trọng tới quý khách hàng ghé thăm trang thông tin điện tử
        ...
        của bạn đến sản phẩm và tìm hiểu về trang thông tin điện tử của chúng tôi.</p>
      <p>Xin vui lòng dành thời gian để đọc và tìm hiểu những điều khoản về thỏa thuận pháp lý giữa bạn và Mitsubishi
        Kim Liên Hà Nội như dưới đây. Thông qua việc truy cập, duyệt nội dung, hoặc sử dụng trang thông tin điện tử này,
        bạn công nhận rằng bạn đã đọc, hiểu và nhất trí với việc tuân thủ các điều chỉnh của những điều khoản này. Nếu
        bạn không nhất trí với những điều khoản này, xin vui lòng không sử dụng trang thông tin điện tử này.</p>
      ...
      <p>Chúng tôi có thể tiết lộ những thông tin trên cho bên thứ ba nếu bạn đồng ý tiết lộ.<br/>
        ...
        năng, và không được phép chia sẻ thông tin với bất cứ bên thứ ba nào khác.<br/>
        Chúng tôi có thể tiết lộ những thông tin trên nếu được cơ quan nhà nước có thẩm quyền yêu cầu hoặc nếu chúng tôi
        tin rằng làm như vậy là cần thiết để: (a) phù hợp với những đòi hỏi hợp pháp hoặc tuân theo quy trình hợp pháp;
        (b) bảo vệ quyền hoặc tài sản của Mitsubishi Kim Liên Hà Nội hoặc những công ty liên kết; (c) ngăn chặn tội ác
        hoặc bảo vệ quốc gia; hoặc (d) bảo vệ an toàn cá nhân của người sử dụng hoặc công chúng.</p>
      <h2>THAY ĐỔI NỘI DUNG SẢN PHẨM, GIÁ CẢ</h2>
      <p>Tất cả những hình ảnh minh họa, thông tin, thông số kỹ thuật và giá cả được đề cập trên trang thông tin điện tử
        này là chính xác vào thời điểm xây dựng trang thông tin điện tử . Tất cả các giá xe được niêm yết theo giá bán
      ...
      <p>Thông tin trên trang thông tin điện tử này do Mitsubishi Kim Liên Hà Nội cung cấp và hoàn toàn hợp pháp.
        Mitsubishi Kim Liên Hà Nội luôn cố gắng cập nhật và cung cấp tới bạn các thông tin chính xác nhất. Tuy nhiên,
        trong quá trình cung cấp thông tin, trang thông tin điện tử này có thể chứa những sai sót kỹ thuật hoặc lỗi đánh
        máy, do đó, thông tin trên trang thông tin điện tử này không được hứa hẹn hoặc đảm bảo là chính xác, cập nhật
        hoặc hoàn chỉnh.Trong mọi trường hợp, Mitsubishi Kim Liên Hà Nội không chịu trách nhiệm đối với bên nào về bất
        kỳ thiệt hại gián tiếp, trực tiếp, ám chỉ, đặc biệt, mang tính cảnh cáo hoặc mang tính hậu quả ở bất kỳ thể loại
        nào và vì bất kỳ lý do nào liên quan đến hoặc phát sinh từ trang thông tin điện tử này hoặc việc sử dụng trang
        thông tin điện tử này, hoặc của bất kỳ trang thông tin điện tử nào hoặc tài nguyên nào được liên kết với, được
        tham chiếu đến hoặc được truy cập thông qua trang thông tin điệnt ử này, hoặc đối với việc sử dụng hay tải
        xuống, hay truy cập vào bất kỳ tài liệu, thông tin, sản phẩm hoặc dịch vụ nào kể cả khi Mitsubishi Kim Liên Hà
        Nội khuyến nghị rõ ràng về khả năng xảy ra những thiệt hại như vậy.</p>
      <h3>2/ Các liên kết khác</h3>
      <p>Trang thông tin điện tử này có thể có những đường liên kết với các trang thông tin điện tử khác. Mitsubishi Kim
      ...
      <p>Mitsubishi Kim Liên Hà Nội giữ quyền thay đổi những Điều khoản sử dụng trên đây và bất kỳ thông tin nào trong
        ...
        Nội cũng có thể đưa ra những cải tiến hoặc thay đổi trong các sản phẩm, dịch vụ hoặc chương trình được mô tả
        trong trang thông tin điện tử này vào bất kỳ lúc nào mà không báo trước. Chúng tôi sẽ đăng tải những thay đổi đó
        lên trang thông tin điện tử để người sử dụng luôn nhận thức những thông tin chúng tôi thu thập, cách thức chúng
        tôi sử dụng những thông tin đó và những trường hợp mà chúng tôi tiết lộ những thông tin đó.</p>
    </div>
  )
};
